...
class AlunoResourceIT {
    ...
    void createAluno() throws Exception {
        ...
        var returnedAlunoDTO = webTestClient
            .post()
            .uri(ENTITY_API_URL)
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(alunoDTO))
            .exchange()
            .expectStatus()
            .isCreated()
    ...
    void putExistingAluno() throws Exception {
        ...
        webTestClient
            .put()
            .uri(ENTITY_API_URL_ID, alunoDTO.getId())
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(alunoDTO))
            .exchange()
            .expectStatus()
    ...
    void partialUpdateAlunoWithPatch() throws Exception {
        ...
        partialUpdatedAluno.dataNascimento(UPDATED_DATA_NASCIMENTO);
