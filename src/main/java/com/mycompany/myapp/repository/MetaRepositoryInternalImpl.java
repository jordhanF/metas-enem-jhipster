...
class MetaRepositoryInternalImpl extends SimpleR2dbcRepository<Meta, Long> implements MetaRepositoryInternal {
    ...
    @Override
    public Mono<Meta> findOneWithEagerRelationships(Long id) {
        return findById(id);
    }

    @Override
    public Flux<Meta> findAllWithEagerRelationships() {
        return findAll();
    }

    @Override
    public Flux<Meta> findAllWithEagerRelationships(Pageable page) {
